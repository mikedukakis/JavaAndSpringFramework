package sprint1.tasca1.n3exercici1;
...
public class Redaccio {
        ...
        do {
            ...
            switch (opcio) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    resposta = assignarNoticia();
                    break;
                case 4:
                    resposta = eliminarNoticia();
                    break;
                case 5:
                    resposta = veureNoticiesRedactor();
                    break;
                case 6:
                    resposta = puntuacioNoticia();
                    break;
                case 7:
                    resposta = preuNoticia();
                    break;
                case 8:
    ...
    public static String assignarNoticia() {
        String DNI;
        String titular;
        int esport;
        String resposta = "";
        ...
        if (!dniTrobat(DNI)) {
            ...
            System.out.println("De quin esport és la notícia:\n" +
                    "1. Futbol\n" +
                    "2. Bàsquet\n" +
                    "3. Tennis\n" +
                    "4. Fòrmula 1\n" +
    ...
    public static String eliminarNoticia() {
    ...
    public static String veureNoticiesRedactor() {
        String missatge;
        String DNI;
        System.out.println("Indica el DNI del redactor de qui vols veure les notícia: ");
        DNI = entradaTeclat.nextLine();
        if (!dniTrobat(DNI)) {
            missatge = "El DNI no s'ha trobat al sistema";
        } else {
            missatge = buscaRedactor(DNI).getNoticies().toString();
        }
        return missatge;
    }

    public static String puntuacioNoticia() {
        String missatge = "El titular no existeix";
        String DNI;
        String titular;
    ...
    public static String preuNoticia() {
        String missatge = "El titular no existeix";
        String DNI;
        String titular;
        System.out.println("Indica el DNI del redactor de la notícia: ");
    ...
    public static boolean dniTrobat(String DNI) {
        ...
        int i = 0;
        while (i < redactors.size() && !dniTrobat) {
    ...
    public static Redactor buscaRedactor(String DNI) {
        ...
        for (Redactor element : redactors) {
            if (element.getDNI().equalsIgnoreCase(DNI)) {
                redactor = element;
            }
        }
        return redactor;
